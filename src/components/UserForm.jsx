        ...
        <div className='BuyerForm-container'>
            ...
            <Form className='buyerForm' onSubmit={generateOrder} onChange={handleChange}>
                ...
                <Row className="mb-3">
                    ...
                    <Form.Control name="name" required placeholder="Ingresá tu nombre" defaultValue={buyerForm.name} />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formGridPassword">
                    <Form.Label>Apellido</Form.Label>
                    <Form.Control  name="surname" required placeholder="Ingresá tu apellido" defaultValue={buyerForm.surname}/>
                    </Form.Group>
                </Row>

                <Form.Group className="mb-3" controlId="formGridAddress1">
                    <Form.Label>Teléfono</Form.Label>
                    <Form.Control name="phone" required  placeholder="Ingresá tu número telefónico" defaultValue={buyerForm.phone} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formGridAddress2">
                    <Form.Label>Email</Form.Label>
                    <Form.Control type="email" name="email" required placeholder="Inglesá tu email" defaultValue={buyerForm.email} />
